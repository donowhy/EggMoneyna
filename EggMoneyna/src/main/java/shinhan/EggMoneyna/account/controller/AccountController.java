...
//    }
    ...
    @Operation(summary = "계좌 잔액 조회", description = "계좌 잔액 조회.", tags = { "Account Controller" })
    @GetMapping("/getBalance")
    public Response<?> getBalance (@UserInfo UsersInfo usersInfo){
        return new Response<>("성공", "계좌 잔액 조회", accountService.getBalance(usersInfo.getId()));
    }
